...
<Text style={styles.label}>39. Area benifited by proposed works(ha)</Text>
        ...
        <Text style={styles.label}>44. PRADAN Contribution</Text>
        <TextInput
          style={styles.input}
        ...
        <Text style={styles.label}>45. Farmer Contribution</Text>
        <TextInput
          style={styles.input}
          placeholder="Enter amount"
          placeholderTextColor="#888"
        ...
        <Text style={styles.label}>46. Total Estimate Amount</Text>
        <TextInput
          style={styles.input}
          placeholder="Enter amount"
          placeholderTextColor="#888"
