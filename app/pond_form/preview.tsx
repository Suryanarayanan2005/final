...
export default function PreviewPage() {
 ...
 <View style={styles.headerContainer}>
  <TouchableOpacity onPress={() => router.push("/pond_form/bank_details")}>
  ...
  {/* <Text style={styles.photoLabel}>Photo of the Farmer</Text> */}
        ...
        <View style={styles.editButtonContainer}>
          <TouchableOpacity style={styles.editBtn}onPress={() => {
                                                        router.push('/pond_form/bank_details');
                                                      }}>
...
<View style={styles.card}>
        ...
        <View style={styles.item}>
          <Text style={styles.label}>34. Livestock at Home (ha)</Text>
      ...
      <View style={styles.card}>
        ...
        {renderField('35. S.F. No. of the land to be developed', '')}
        <View style={styles.item}>
      ...
      <View style={styles.card}>
        ...
        {renderField('47. Name of Account Holder', '')}
        {renderField('48. Account Number', '')}
        {renderField('49. Name of the Bank', '')}
        {renderField('50. Branch', '')}
        {renderField('51. IFSC', '')}
        {renderField('52. Farmer has agreed for the work, and his contribution', '')}

        {/* Field 50: Files submitted */}
        <View style={styles.item}>
          <Text style={styles.label}>53. Files submitted:</Text>
          {[
            'Patta',
            'ID Card',
            'FMB',
            ...
            <View key={index} style={styles.fileRow}>
              ...
              <View style={styles.fileRight}>
                ...
                <Ionicons name="eye-outline" size={width * 0.06} color="#388E3C" style={{ marginLeft: 10 }} />
              </View>
            </View>
          ))}
        </View>
