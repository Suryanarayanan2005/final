    ...
    <KeyboardAwareScrollView style={styles.container}>
      <ScrollView contentContainerStyle={styles.inner}>
        <Animatable.View animation="fadeInUp" duration={600}>
          ...
          <Text style={styles.label}>47. Name of Account Holder</Text>
          <TextInput
            style={styles.input}
          ...
          <Text style={styles.label}>48. Account Number</Text>
          <TextInput
            style={styles.input}
          ...
          <Text style={styles.label}>49. Name of the Bank</Text>
          <TextInput
            style={styles.input}
          ...
          <Text style={styles.label}>50. Branch</Text>
          <TextInput
            style={styles.input}
          ...
          <Text style={styles.label}>51. IFSC</Text>
          <TextInput
            style={styles.input}
          ...
          <Text style={styles.label}>52. Farmer has agreed for the work, and his contribution</Text>
